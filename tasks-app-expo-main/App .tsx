 ...
 * Atualizado com feedbacks visuais inteligentes.
 * - Texto riscado para tarefas concluídas.
 * - Subtexto revelador para datas de vencimento.
 */
const TaskItem = ({ item, updateMode, deleteToDo }: { 
  ...
  // Condição dinâmica para o estilo do texto
  const textStyle = [
    styles.text,
  ...
  return (
    <View style={[styles.todo, item.completed && styles.todoCompleted]}>
      <View style={styles.todoContent}>
        ...
        {/* Subtexto revelador indicando o vencimento */}
        {item.dueDate && (
          <View style={styles.dateContainer}>
            <Feather name="clock" size={12} color={item.completed ? "#bbb" : "#666"} />
            <Text style={[styles.dateText, item.completed && { color: '#bbb' }]}>
